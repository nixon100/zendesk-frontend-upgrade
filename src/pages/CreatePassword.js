          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-12 d-flex flex-column justify-content-center align-items-center">
                <div>
                  <h5>Password Created Successfully</h5>
                </div>
                <div class="confirm-subHead">You can close this tab now</div>
                <div class="confirm-note mt-4">
                  Note: Use the same credentials for both GUVI and ZEN Class
                </div>
                <div class="rowww">
                  <div class="confirm-line-1"></div>
                  <div class="mx-2">or</div>
                  <div class="confirm-line-1"></div>
                </div>
                <div class="row">
                  <button class="continue-btn" onClick={handle}>Continue to login</button>
                </div>
              </div>
            </div>
